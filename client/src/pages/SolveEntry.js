...
import './SolveEntry.css'

const SolveEntry = () => {

  const { dimensions, tableau, setTableau, setDimensions } = useContext(MatrixContext)
  const navigate = useNavigate()

  const move = () => {
    navigate('/start-solve')
  }
      ...
      <div>
        ...
        <Form style={{ width: '50vw' }} >
          ...
          <Form.Group
            ...
            controlId='validCustom01'
          >
            <Form.Label className="text-light">Today's Date</Form.Label>
            <Form.Control
              required
              type="date"
