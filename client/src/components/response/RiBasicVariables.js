...
import useCreateBasicVariabeles from '../../hook/usecreateBasicVariables'
...
const BasicVariables = () => {
  ...
  useCreateBasicVariabeles(dimensions, temp, temp_rows, setRows, setHeader,preventNewLine,tableau,setTableau)
