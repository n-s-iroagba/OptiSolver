import { cePush } from "./push";
import { cRowPush } from "./push";

const createConstraintEquations = async (setHeader, preventNewLine, dimensions, setRows, setCrow, tableau, setTableau) => {
