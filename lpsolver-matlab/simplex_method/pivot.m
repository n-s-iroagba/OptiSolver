...
for i = 1:rows
    if i == minimum_row_index
        ...
        constraint_equation_matrix(i,:) = constraint_equation_matrix(minimum_row_index,:)-((constraint_equation_matrix(minimum_row_index,:)/constraint_equation_matrix(i,most_negative_column))*constraint_equation_matrix(i,most_negative_column))
